export type TranslationCode = '' | 'es' | 'fr' | 'de' | 'pt' | 'zh' | 'ar';

const SUPPORTED_TRANSLATION_CODES = ['es', 'fr', 'de', 'pt', 'zh', 'ar'] as const;

const SUPPORTED_TRANSLATION_CODE_SET: ReadonlySet<string> = new Set(SUPPORTED_TRANSLATION_CODES);

export function isSupportedTranslationCode(value: string): value is Exclude<TranslationCode, ''> {
  return SUPPORTED_TRANSLATION_CODE_SET.has(value);
}
...
const TASK_DETAIL_COPY: Record<Exclude<TranslationCode, ''>, TaskDetailCopy> = {
  es: {
    backToFeed: 'Volver a las tareas', postedBy: 'Publicado por', verified: 'Verificado', unverified: 'Sin verificar', autoTranslated: 'Traducido automáticamente', minutes: 'min', max: 'Máximo', theMission: 'La misión', translationNotice: 'Traducción automática. Comprueba los matices con el original antes de enviarlo.', translating: 'Traduciendo…', viewOriginal: 'Ver original', viewTranslation: 'Ver traducción', translationUnavailable: 'La traducción no está disponible.', noDescription: 'No se proporcionó una descripción detallada.', signInToClaimTask: 'Inicia sesión para reclamar esta tarea.', signInToClaim: 'Iniciar sesión para reclamarla', readyToHelp: '¿Listo para ayudar?', claimTask: 'Reclamar esta tarea'
  },
  fr: {
    backToFeed: 'Retour aux tâches', postedBy: 'Publié par', verified: 'Vérifié', unverified: 'Non vérifié', autoTranslated: 'Traduit automatiquement', minutes: 'min', max: 'Maximum', theMission: 'La mission', translationNotice: 'Traduction automatique. Vérifiez les nuances avec l’original avant de répondre.', translating: 'Traduction en cours…', viewOriginal: 'Voir l’original', viewTranslation: 'Voir la traduction', translationUnavailable: 'Traduction indisponible.', noDescription: 'Aucune description détaillée n’a été fournie.', signInToClaimTask: 'Connectez-vous pour réclamer cette tâche.', signInToClaim: 'Se connecter pour la réclamer', readyToHelp: 'Prêt à aider ?', claimTask: 'Réclamer cette tâche'
  },
  de: {
    backToFeed: 'Zurück zu den Aufgaben', postedBy: 'Veröffentlicht von', verified: 'Verifiziert', unverified: 'Nicht verifiziert', autoTranslated: 'Automatisch übersetzt', minutes: 'Min.', max: 'Maximal', theMission: 'Die Aufgabe', translationNotice: 'Automatisch übersetzt. Prüfe die Bedeutung vor dem Absenden mit dem Original.', translating: 'Wird übersetzt…', viewOriginal: 'Original anzeigen', viewTranslation: 'Übersetzung anzeigen', translationUnavailable: 'Übersetzung nicht verfügbar.', noDescription: 'Es wurde keine ausführliche Beschreibung angegeben.', signInToClaimTask: 'Melde dich an, um diese Aufgabe zu übernehmen.', signInToClaim: 'Anmelden und übernehmen', readyToHelp: 'Bereit zu helfen?', claimTask: 'Aufgabe übernehmen'
  },
  pt: {
    backToFeed: 'Voltar às tarefas', postedBy: 'Publicado por', verified: 'Verificado', unverified: 'Não verificado', autoTranslated: 'Traduzido automaticamente', minutes: 'min', max: 'Máximo', theMission: 'A missão', translationNotice: 'Tradução automática. Confira as nuances no original antes de enviar.', translating: 'Traduzindo…', viewOriginal: 'Ver original', viewTranslation: 'Ver tradução', translationUnavailable: 'Tradução indisponível.', noDescription: 'Não foi fornecida uma descrição detalhada.', signInToClaimTask: 'Entre para assumir esta tarefa.', signInToClaim: 'Entrar para assumir', readyToHelp: 'Pronto para ajudar?', claimTask: 'Assumir esta tarefa'
  },
  zh: {
    backToFeed: '返回任务列表', postedBy: '发布者', verified: '已验证', unverified: '未验证', autoTranslated: '自动翻译', minutes: '分钟', max: '最多', theMission: '任务说明', translationNotice: '此内容由机器翻译。提交前请对照原文核对意思。', translating: '正在翻译…', viewOriginal: '查看原文', viewTranslation: '查看译文', translationUnavailable: '翻译不可用。', noDescription: '未提供详细说明。', signInToClaimTask: '登录后即可认领此任务。', signInToClaim: '登录并认领', readyToHelp: '准备好帮忙了吗？', claimTask: '认领此任务'
  },
  ar: {
    backToFeed: 'العودة إلى المهام', postedBy: 'نشرها', verified: 'موثّق', unverified: 'غير موثّق', autoTranslated: 'مترجم آليًا', minutes: 'دقيقة', max: 'الحد الأقصى', theMission: 'المهمة', translationNotice: 'هذه ترجمة آلية. راجع المعنى مقابل النص الأصلي قبل الإرسال.', translating: 'جارٍ الترجمة…', viewOriginal: 'عرض النص الأصلي', viewTranslation: 'عرض الترجمة', translationUnavailable: 'الترجمة غير متاحة.', noDescription: 'لم يتم تقديم وصف تفصيلي.', signInToClaimTask: 'سجّل الدخول لتولي هذه المهمة.', signInToClaim: 'سجّل الدخول لتوليها', readyToHelp: 'هل أنت مستعد للمساعدة؟', claimTask: 'تولَّ هذه المهمة'
  }
};
